        ...
        <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200">
            <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
                ...
                <div className="flex justify-center">
                    <a href="https://www.instagram.com/creditpaisaofficial?igsh=OGQ5ZDc2ODk2ZA%3D%3D&utm_source=qr" className="mr-6 text-neutral-600 dark:text-neutral-200">
                        <svg
                    ...
                    <a href="https://www.facebook.com/creditpaisaofficial/" className="mr-6 text-neutral-600 dark:text-neutral-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
            ...
            <div className="mx-6 py-10 text-left md:text-left">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="mb-4">
                        <h6 className="mb-2 font-semibold uppercase ml-4">
                            Contact Us
                        </h6>
                        <ul className="list-disc pl-6">
                            <li><strong>Address:</strong> Gurugram, India</li>
                            <li className="mt-2"><strong>Email:</strong> info@creditpaisa.com</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-6 py-2 text-center md:text-left">
                <Link to="/privacy" className="text-neutral-600 dark:text-neutral-200">Privacy Policy</Link>
            </div>
            <div className="flex items-center justify-center space-x-2">
                <span className="text-m">Built with love, made in India</span>
