  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-screen-lg">
        <div className="bg-gradient-to-r from-cyan-400 to-orange-500 bg-opacity-90 backdrop-blur-md rounded-lg p-6 text-center text-white mt-4">
        ...
        <div className="bg-gradient-to-r from-cyan-400 to-orange-500 bg-opacity-90 backdrop-blur-md rounded-lg p-6 text-center text-white mb-4">
